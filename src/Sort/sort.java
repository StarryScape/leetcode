...
public class sort {
    ...
    /**
     * <a href="https://leetcode.cn/problems/sort-colors/description/?envType=study-plan-v2&envId=top-100-liked"> 颜色分类</a>
     * @param nums
     */
...
//        [2,0,2,1,1,0]
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(sortColors(new int[]{2, 2, 2})));
    }
}
